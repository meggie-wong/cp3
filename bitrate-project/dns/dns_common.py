...
FLAGS_AA = 0 #should be zero in query
...
#    print "QR:     %d" % R_FLAGS_QR
#    print "Opcode: %d" % R_FLAGS_Opcode
#    print "AA:     %d" % R_FLAGS_AA
#    print "TC:     %d" % R_FLAGS_TC
#    print "RD:     %d" % R_FLAGS_RD

    R_FLAGS_RA = (R_FLAGS_B2 & 128) >> 7
    R_FLAGS_Zero = (R_FLAGS_B2 & (7<<4)) >> 4
    R_FLAGS_RCode = R_FLAGS_B2 & 15

#    print "RA:     %d" % R_FLAGS_RA
#    print "Zero:   %d" % R_FLAGS_Zero
#    print "RCode:  %d" % R_FLAGS_RCode
...
#    print "QDCOUNT: %d" % R_NUM_QUESTIONS
#    print "ANCOUNT: %d" % R_NUM_ANSWERS
#    print "NSCOUNT: %d" % R_NUM_AUTHORITY
#    print "ARCOUNT: %d" % R_NUM_ADDITIONAL
...
#    print "R_QType:  %d" % R_QType
#    print "R_QClass: %d" % R_QClass
